...
export async function POST(
  ...
  try {
    ...
    const apiUrl = getApiUrl(`admin/users/${params.userId}/reject/`);
    console.log('Rejecting user at:', apiUrl);
    ...
    console.error('Error in POST /api/admin/users/[userId]/reject:', error);
